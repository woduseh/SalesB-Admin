<div class="container">
	<div class="search container">
		<form:form method="get" modelAttribute="AdminRequestForm">
		...
		<table id="requestTable">
			...
			<c:forEach var="Request" items="${page.content}">
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath}/admin/requestdetail?requestnum=${Request.seq}">${f:h(Request.requestName)}</a></td>
