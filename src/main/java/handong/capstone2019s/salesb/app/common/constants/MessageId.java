...
public final class MessageId {
	...
	/**
	 * <strong>label.tr.common.pageNotFoundMessage = That page is not
	 * found.</strong>
	 */
	public static final String LABEL_TR_COMMON_PAGENOTFOUNDMESSAGE = "label.tr.common.pageNotFoundMessage";

	/**
	 * <strong>label.tr.common.pageUnauthorizedMessage = Need to
	...
	/**
	 * <strong>label.tr.common.companyName = TERASOLUNA TRAVEL CUSTOMER
	 * CENTER</strong>
	 */
	...
	/**
	 * <strong>label.tr.common.pdfdownloadMessage = PDF can be download for this
	 * information</strong>
	 */
	...
	/**
	 * <strong>e.tr.fw.0005 = Expected CSRF token not found. Has your session
	 * expired?</strong>
	 */
	...
	/**
	 * <strong>label.tr.menu.tourSearchMessage = You can search tours with the
	 * specified conditions. <br>
	 * You can also search for tour reservations. You must be logged in to the
	 * reservation.</strong>
	 */
	...
	/**
	 * <strong>label.tr.menu.loginMessage = you can reserve tours and change, cancel
	 * reservations after you login. <br>
	...
	/**
	 * <strong>label.tr.menu.customerRegisterMessage = Enter your information to
	 * register membership</strong>
	 */
	...
	/**
	 * <strong>label.tr.menu.referMessage = you can change tours and cancel
	 * reservations</strong>
	 */
	...
	/**
	 * <strong>label.tr.login.notCustmerMessage = Customers do not have a member ID,
	 * please register your membership with the buttons below.</strong>
	 */
	public static final String LABEL_TR_LOGIN_NOTCUSTMERMESSAGE = "label.tr.login.notCustmerMessage";

	/**
	 * <strong>label.tr.managecustomer.managecustomerMessage = Register
	 * Customer</strong>
	 */
	...
	/**
	 * <strong>label.tr.managecustomer.createFormMessage = <strong>Membership
	 * information input</strong> -> Confirm information -> Completed<br>
	...
	/**
	 * <strong>label.tr.managecustomer.createConfirmMessage = Membership information
	 * input -> <strong>Confirm information</strong> -> Completed<br>
	...
	/**
	 * <strong>label.tr.managecustomer.createCompleteMessage = Membership
	 * information input -> Confirm information -> <strong>Completed</strong><br>
	 * Membership registration was completed. Your "User Id" is
	 * <strong>{0}</strong>.<br>
	 * <strong>Please do not forget because you will need at
	 * login.</strong></strong>
	 */
	 ...
	 * <strong>label.tr.managecustomer.createCompleteMessage = Membership
	 * information input -> Confirm information -> <strong>Completed</strong><br>
	 * Admin registration was completed. Your "Admin Id" is
	 * <strong>{0}</strong>.<br>
	 * <strong>Please do not forget because you will need at
	 * login.</strong></strong>
	 */
	...
	/**
	 * <strong>label.tr.managecustomer.fullKanaOnlyMessage = Full-width Katakana
	 * only</strong>
	 */
	...
	/**
	 * <strong>label.tr.managecustomer.halfTelOnlyMessage = Half-width 10 digits to
	 * 13 digits numeric only</strong>
	 */
	...
	/**
	 * <strong>label.tr.managecustomer.halfPasswordOnlyMessage = Half-width 4 digits
	 * to 20 digits alphanumeric only</strong>
	 */
	 ...
	 * <p>
	 * <strong>Search Tour</strong> -> Check the contents ⇒ Confirm reservation ->
	 * Completed
	 * </p>
	 * <p>
	 ...
	 * <li>Check the contents of the tour in Tour Details screen, please proceed to
	 * the next screen if there is no problem. (Reservations are not yet.)</li>
	 * <li>Confirm your reservation, please perform a reservation if there is no
	 * problem.</li>
	 * <li>For more information please check tour, membership information, fee
	 * details, the payment information screen tour reservation registration is
	 * complete.</li>
	 * </ol>
	 * <p>
	 * Search for tours by specifying the conditions, please select a tour from the
	 * search results. The tour can be selected by pressing the link name of the
	 * tour.
	 * </p>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.SearchCriteriaTourMessage = Tour Search
	 * Condition</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_SEARCHCRITERIATOURMESSAGE = "label.tr.searchtour.SearchCriteriaTourMessage";

	/**
	 * <strong>label.tr.searchtour.depDateRestrictMessage = Please enter dates in
	 * the future after one week from today</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_DEPDATERESTRICTMESSAGE = "label.tr.searchtour.depDateRestrictMessage";

	/**
	 * <strong>label.tr.searchtour.personsRestrictMessage = Adult：over 12 years old
	 * Child：under 12 years old</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_PERSONSRESTRICTMESSAGE = "label.tr.searchtour.personsRestrictMessage";

	/**
	 * <strong>label.tr.searchtour.searchTourResultMessage = Tour Search Result
	 * (sorted by tour days, base price)</strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.statementOfCharges = Statement of
	 * Charges</strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.lessThanEightyCharsMessage = (Less than 80
	 * Characters)</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_LESSTHANEIGHTYCHARSMESSAGE = "label.tr.searchtour.lessThanEightyCharsMessage";

	/**
	 * <strong>label.tr.searchtour.opinionSuggestionMessage = * If there is opinion
	 * or suggestion regarding the tour, please mention it here</strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.titleConfirmScreenMessage = Tour Confirmation
	 * Screen</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_TITLECONFIRMSCREENMESSAGE = "label.tr.searchtour.titleConfirmScreenMessage";

	/**
	 * <strong>label.tr.searchtour.reserveScreenTitleMessage = Please check the
	 * reservation details<br />
	 * Press "Download PDF"button to save the reservation information in PDF
	 * format.</strong>
	 */
	 ...
	 * Please pay before the due date in the bank account or directly at the window
	 * <br />
	...
	/**
	 * <strong>label.tr.searchtour.searchtourReserveDetailMessage = Tour Reservation
	...
	/**
	 * <strong>label.tr.searchtour.reserveDate = Tour Search&nbsp;⇒&nbsp;Tour
	 * Details&nbsp;⇒&nbsp;Confirmation of Tour
	...
	/**
	 * <strong>label.tr.searchtour.reserveNo = Tour Search&nbsp;⇒&nbsp;Tour
	 * Details&nbsp;⇒&nbsp;<strong>Confirmation of Tour
	 * Details</strong>&nbsp;⇒&nbsp;Finish</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_RESERVENO = "label.tr.searchtour.reserveNo";

	/**
	 * <strong>label.tr.searchtour.goTourSearchScreenMessage = Tour
	 * Search&nbsp;⇒&nbsp;<strong>Tour Details</strong>&nbsp;⇒&nbsp;Confirmation of
	 * Tour Details&nbsp;⇒&nbsp;Finish</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_GOTOURSEARCHSCREENMESSAGE = "label.tr.searchtour.goTourSearchScreenMessage";

	/**
	 * <strong>label.tr.managereservation.manageReservationMessage = Refer
	 * Reservations Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationFlowMessage =
	 * <strong>Confirm the List of Reservations </strong> ⇒ Confirm the Details</br>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationNoRecordMessage = For
	 * refering the details or making changes to a reservation or canceling a
	 * reservation, <br />
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationNoCancelMessage = The
	 * Tours for which the payment has been done or payment due date has already
	 * passed, <br />
	...
	/**
	 * <strong>label.tr.managereservation.ReserveListMessage = Reservation
	 * List&nbsp;&nbsp; <font>※Shown in the ascending order of departure and
	 * reservation no</font></strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.showDetailsBtnMessage = Show
	 * Details</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.changeReservationBtnMessage = Edit the
	 * Reservation</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.cancelReservationBtnMessage = Cancel the
	 * Reservation</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.changeReservationFinBtnMessage = Finalize
	 * the Changes</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.changeReservationStaBtnMessage = Start
	 * Over Again</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.returnToListScreenBtnMessage = Return to
	 * List of Reservations</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.updatedScreenFlowMessage = <font>Edit the
	 * contents</font> &nbsp;⇒&nbsp;<font>Confirm the edited
	 * contents</font>&nbsp;⇒&nbsp;<font><strong>Finish</strong></font> <br />
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.updatedFinishMessage = The reservation has
	 * been changed as below.<br>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.paymentReminderMessage = Please make the
	 * payment at the reception or in the bank account before the payment
	 * due-date.<br />
	 * Also, please note that if payment is not done by the due-date, it is possible
	 * that the reservation may get cancelled.<br />
	...
	/**
	 * <strong>label.tr.managereservation.paymentNoCancelMessage = The payment for
	 * this reservation has been done.<br />
	 * Thereby, this reservation cannot be changed or cancelled from the web.<br />
	 * Please visit the travel desk or contact us on phone at (01-2345-6789) for
	 * changes and cancellation related procedures<br />
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.updatedCompleteMessage = Reservation is
	 * changed as above.</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationShowScreenTitleMessage =
	 * Reservation Detail Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationShowScreenFlowMessage =
	 * <font>Confirm the list of reservations</font>&nbsp;⇒&nbsp;
	 * <font><strong>Confirm the details of a Reservation</strong></font></strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationShowMessage = Please
	 * confirm the detail information of the reservation made by you.<br />
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationUpdatedScreenTitleMessage
	 * = Reservation Change Completion Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationConfirmScreenTitleMessage
	 * = Reservation Change Confirmation Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationConfirmScreenFlowMessage
	 * = <font>Make Changes</font> &nbsp;⇒&nbsp;<font><strong>Confirm the
	 * Changes</strong></font> &nbsp;⇒&nbsp;<font>Finish</font> <br />
	 * </strong>
	 */
	 ...
	 * <p>
	 * If there is no problem with the changed contents, press the "Change
	 * Reservation" button below.&nbsp;
	 * </p>
	 * </strong>
	 */
	 ...
	 * <p>
	 * Reservation will be changed according to the information above. Is it OK to
	 * proceed ?
	 * </p>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationEditScreenTitle = Change
	 * Reservation Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationEditFlowMessage =
	 * <font><strong>Make Changes</strong></font> &nbsp;⇒&nbsp;<font>Confirm the
	 * Changes</font> &nbsp;⇒&nbsp;<font>Finish</font> <br />
	 * </strong>
	 */
	 ...
	 * <p>
	 * After making changes to the reservation, press the "Confirm Reservation"
	 * button below.&nbsp;
	 * </p>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.beforecancelScreenTitleMessage =
	 * Confirmation Screen for Reservation Cancellation</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.beforecancelScreenFlowMessage =
	 * <strong>Confirm Cancellation Contents</strong>&nbsp;⇒&nbsp;Finish</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.beforeCancelScreenMessage = Please Press
	 * "Cancel Reservation" button below if this reservation is to be
	 * cancelled.</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.aftercancelScreenTitleMessage =
	 * Reservation Cancellation Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.aftercancelScreenFlowMessage = Confirm
	 * Cancellation Contents&nbsp;⇒&nbsp;<strong>Finish</strong></strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.aftercancelScreenMessage = Tour
	 * Reservation with Reservation Number: {0}, is cancelled.</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.confirmEditBtnMessage = Confirm the
	 * Change</strong>
	 */
	...
	/**
	 * lable.tr.admin.request.form.table.introduce = 최근 요청
	 */
	public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_INTRODUCE = "lable.tr.admin.request.form.table.introduce";

	/**
	 * lable.tr.admin.request.form.table.header.seq = 요청 번호
	 */
	public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_SEQ = "lable.tr.admin.request.form.table.header.seq";

	/**
	 * lable.tr.admin.request.form.table.header.client = 요청인
	 */
	public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_CLIENT = "lable.tr.admin.request.form.table.header.client";

	/**
	 * lable.tr.admin.request.form.table.header.request.name = 요청 제목
	 */
	public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_REQUEST_NAME = "lable.tr.admin.request.form.table.header.request.name";

	/**
	 * lable.tr.admin.request.form.table.header.request.content = 요청 내용
	 */
	public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_REQUEST_CONTENT = "lable.tr.admin.request.form.table.header.request.content";

	/**
	 * lable.tr.admin.request.form.table.header.update.time = 요청 시간
	 */
	public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_UPDATE_TIME = "lable.tr.admin.request.form.table.header.update.time";

	/**
	 * lable.tr.no.result = 검색 결과가 없습니다!
	 */
	public static final String LABEL_TR_NO_RESULT = "lable.tr.no.result";

	/**
	 * lable.tr.menu.no.result = 최근 1주일 내에 받은 요청이 없습니다.
	 */
	public static final String LABLE_TR_MENU_NO_RESULT = "lable.tr.menu.no.result";

	/**
	 * label.tr.menu.store.manage = store manage
	 */
	public static final String LABEL_TR_MENU_STORE_MANAGE = "label.tr.menu.store.manage";

	/**
	 * label.tr.menu.request.manage = request list
	 */
	public static final String LABEL_TR_MENU_REQUEST_MANAGE = "label.tr.menu.request.manage";

	/**
	 * label.tr.menu.return = Return to Main
	 */
	public static final String LABEL_TR_MENU_RETURN = "label.tr.menu.return";

	/**
	 * able.tr.admin.manage.form.table.header.admincode = 관리자 번호
	 */
	public static final String LABLE_TR_ADMIN_MANAGE_FORM_TABLE_HEADER_ADMINCODE = "lable.tr.admin.manage.form.table.header.admincode";
	
	/**
	 * lable.tr.admin.manage.form.table.header.adminName = 관리자 이름
	 */
	public static final String LABLE_TR_ADMIN_MANAGE_FORM_TABLE_HEADER_ADMINNAME = "lable.tr.admin.manage.form.table.header.adminName";
	
	/**
	 * lable.tr.admin.manage.form.table.header.adminMail = 관리자 메일
	 */
	public static final String LABLE_TR_ADMIN_MANAGE_FORM_TABLE_HEADER_ADMINMAIL = "lable.tr.admin.manage.form.table.header.adminMail";
	
	/**
	 * lable.tr.admin.manage.form.table.header.adminPass = 관리자 비밀번호
	 */
	public static final String LABLE_TR_ADMIN_MANAGE_FORM_TABLE_HEADER_ADMINPASS = "lable.tr.admin.manage.form.table.header.adminPass";
	
	/**
	 * lable.tr.admin.manage.form.table.header.adminTel = 관리자 전화번호
	 */
	public static final String LABLE_TR_ADMIN_MANAGE_FORM_TABLE_HEADER_ADMINTEL = "lable.tr.admin.manage.form.table.header.adminTel";
	
	/**
	 * lable.tr.admin.manage.form.table.header.adminAuthority = 관리자 접근 권한
	 */
	public static final String LABLE_TR_ADMIN_MANAGE_FORM_TABLE_HEADER_ADMINAUTHORITY = "lable.tr.admin.manage.form.table.header.adminAuthority";
